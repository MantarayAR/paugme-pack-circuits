 ...
 */
Cellular.prototype._completeMaze = function() {
	var allFreeSpace = [];
	var notConnected = {};
	// find all free space
...
Cellular.prototype._findConnected = function(connected, notConnected, stack, keepNotConnected) {
...
Cellular.prototype._tunnelToConnected = function(to, from, connected, notConnected) {
...
Cellular.prototype._freeSpace = function(x, y) {
